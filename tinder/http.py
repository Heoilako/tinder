...
TINDER_IOS_USER_AGENT: str = 'Tinder/15.2.0 (iPhone; iOS 15.8; Scale/2.00)'
TINDER_IOS_VERSION: str = '15.2.0'

class Http:
    _base_url = "https://api.gotinder.com"
    _headers = {
        "User-agent":TINDER_IOS_USER_AGENT,
        "Content-Type": "application/json",'accept-language': 'en-US,en;q=0.9', 'tinder-version': TINDER_IOS_VERSION,  'platform': 'ios',
        "X-Auth-Token": "",
    }
    _reattempt_count = {}
    _request_count = 0
